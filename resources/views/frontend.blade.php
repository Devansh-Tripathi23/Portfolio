...
<div class="container-fluid">
    <div class="row banner_styling">
        ...
        <div class="col-md-6 my-5 image_div_styling">
            <img src="{{asset('images/mypic2.png')}}" alt="mypic" class="mypic_styling "/>
        </div>
    </div>
</div>
